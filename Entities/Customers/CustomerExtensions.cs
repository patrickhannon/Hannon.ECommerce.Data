...
namespace ECommerce.Data.Entities.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(HanCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(HanCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        {
            return IsInCustomerRole(customer, HanCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, HanCustomerDefaults.ForumModeratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, HanCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, HanCustomerDefaults.GuestsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, HanCustomerDefaults.VendorsRoleName, onlyActiveCustomerRoles);
        }
